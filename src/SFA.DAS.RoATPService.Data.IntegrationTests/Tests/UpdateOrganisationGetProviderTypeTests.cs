...
{
    public class UpdateOrganisationGetProviderTypeTests : TestBase
    {
        ...
        [Test]
        public void Provider_type_is_returned()
        {
            var actualProviderType = _repository.GetProviderType(_organisationId).Result;
            Assert.AreEqual(_providerTypeId1, actualProviderType);
        }

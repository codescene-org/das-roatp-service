...
{
    public class UpdateOrganisationGetTradingNameTests : TestBase
    {
        ...
        [Test]
        public void Legal_name_is_returned()
        {
            var actualTradingName = _repository.GetTradingName(_organisationId).Result;
            Assert.AreEqual(_tradingName, actualTradingName);
        }

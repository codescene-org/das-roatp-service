...
{
    public class UpdateOrganisationGetLegalNameTests : TestBase
    {
        ...
        {
            var actualLegalName = _repository.GetLegalName(_organisationId).Result;
            Assert.AreEqual(_legalName,actualLegalName);
        }

...
{
    public class UpdateOrganisationGetParentCompanyGuaranteeTests : TestBase
    {
        ...
        [Test]
        public void Parent_company_guarantee_is_returned()
        {
            var actualParentCompanyGuarantee = _repository.GetParentCompanyGuarantee(_organisationId).Result;
            Assert.AreEqual(_parentCompanyGuarantee, actualParentCompanyGuarantee);
        }

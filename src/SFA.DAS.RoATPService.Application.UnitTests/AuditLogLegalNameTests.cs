...
{
    [TestFixture]
    public class AuditLogLegalNsameTests
    {
        ...
        public void Audit_log_checks_parent_company_guarantee_audit_is_as_expected(string currentName, string newName, bool auditChangesMade)
        {
